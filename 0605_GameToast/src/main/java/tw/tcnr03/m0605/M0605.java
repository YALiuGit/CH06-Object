...
// 1 - scissors, 2 - stone, 3 - net.
        switch (v.getId()){
            case R.id.m0605_b001:
                u_select=getString(R.string.m0605_s001)+getString(R.string.m0605_b001);
                switch (iComp){
                    case 1:
                        c001.setImageResource(R.drawable.scissors);
//                        ans=getString(R.string.m0605_f000)+getString(R.string.m0605_f003);
//                        f000.setTextColor(Color.YELLOW);
                        music(2);
                        break;
                    case 2:
                        c001.setImageResource(R.drawable.stone);
//                        ans=getString(R.string.m0605_f000)+getString(R.string.m0605_f002);
//                        f000.setTextColor(Color.RED);
                        music(3);
                        break;
                    case 3:
                        c001.setImageResource(R.drawable.net);
//                        ans=getString(R.string.m0605_f000)+getString(R.string.m0605_f001);
...
//-------------------------------------------------------
            case R.id.m0605_b002:
                u_select=getString(R.string.m0605_s001)+getString(R.string.m0605_b002);
                switch (iComp){
                    case 1:
                        c001.setImageResource(R.drawable.stone);
//                        ans=getString(R.string.m0605_f000)+getString(R.string.m0605_f003);
...
//-------------------------------------------------------
            case R.id.m0605_b003:
                u_select=getString(R.string.m0605_s001)+getString(R.string.m0605_b003);
                switch (iComp){
                    case 1:
                        c001.setImageResource(R.drawable.net);
//                        ans=getString(R.string.m0605_f000)+getString(R.string.m0605_f003);
       ...
       if(win.isPlaying())  win.pause();
        ...
        switch (i){
            case 1:
                ...
                ans=getString(R.string.m0605_f000)+getString(R.string.m0605_f001);
                f000.setTextColor(Color.GREEN);
                Toast.makeText(getApplicationContext(), R.string.m0605_f001,
